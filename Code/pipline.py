...
ctag_ctag_relations, ctag_nctag_relation_relations, nctag_nctag_relations = data_generator.ctag_relation(ctag_comps_aggregated), data_generator.ctag_nctag_relation(ctag_comps_aggregated, nctag_comps_aggregated, nctag_idf), data_generator.nctag_nctag(nctag_comps_aggregated, nctag_idf)
